...
export const fireHorizontalRay = function (startX = player.x, startY = player.y, rayAngle = player.direction) {
...
export const fireVerticalRay = function (startX = player.x, startY = player.y, rayAngle = player.direction) {
    let mapx = 0, mapy = 0, mapIndex = 0;
    let dof = 0, xOffset = 0, yOffset = 0;
    let rayX = 0, rayY = 0;
...
export const fireRay = function (startX = player.x, startY = player.y, rayAngle = player.direction) {
...
export const drawRays = function (amount = 90, topdown = false) {
